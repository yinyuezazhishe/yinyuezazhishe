...
Route::group(['middleware'=>'adminlogin'], function ()
{
	...
	Route::group(['middleware'=>'u_r_p'], function ()
	{
		...
		//后台用户修改头像
		Route::get('/admin/usertFace','Admin\AdminUsersController@setFace');
		Route::post('/admin/user/do_setFace','Admin\AdminUsersController@do_setFace');

		//后台用户主题修改
		Route::get('/admintTheme','Admin\AdminUsersController@setTheme');
		//后台用户修改密码
		Route::get('/admintPass','Admin\AdminUsersController@setPass');
		...
		// 后台列表管理
		Route::resource('adminsts', 'Admin\AdminListsController');
		// 后台列表状态
		Route::get('adminsts/{id}/edit_status', 'Admin\AdminListsController@edit_status');
		...
		Route::prefix('admin')->group(function(){
			...
			Route::get('integral/{id}ow','Admin\HomeIntegralController@show');
