...
<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        <form class="form-horizontal m-t" id="signupForm" action="/admin/details/{{$res->id}}" novalidate="novalidate" id="uploadForm" enctype='multipart/form-data' method="post">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="dataTables_length" id="DataTables_Table_0_length">
                        <select name="cid" disabled aria-controls="DataTables_Table_0" class="form-control input-sm" >
                            @foreach($rs as $k => $v)
                                @php
                                ...
                                @endphp
                            <option  @if ($res->lists->cid == $v->id) selected  @endif value='{{$v->id}}'>{{$v->catename}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="title" aria-required="true" aria-invalid="true" class="form-control" type="text" value="{{$res->details_content->title}}" class="error">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="author" aria-required="true" aria-invalid="true" class="form-control" type="text" value="{{$res->details_content->author}}" class="error">
                    <span class="help-block m-b-none mytitle">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="saying" aria-required="true" aria-invalid="true" class="form-control" type="text" value="{{$res->details_content->saying}}" class="error">
                    <span class="help-block m-b-none mytitle">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="4" id="area"  name="describe" onkeyup="javascript:checkWord(this);" onmousedown="javascript:checkWord(this);" aria-required="true" aria-invalid="true" class="form-control" class="error">{{$res->details_content->describe}}</textarea>
                    <span class="help-block m-b-none mytitle">
                    ...
                    <div class="form-group" style="margin-left:0px;" >
                        <div class="fileinput myfile fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
                            <div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
                                <img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="{{$res->details_content->picstream}}" alt="" />
                            </div>
                            ...
                            <span class="help-block m-b-none">
                                <i class="fa fa-info-circle"></i>请选择图片欣赏(该图片可选可不选)
                            </span>
                        </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <script id="editor" name="content" value="" type="text/plain" style="height:450px;">{!!$res->details_content->content!!}</script>
                    <span class="help-block m-b-none">
